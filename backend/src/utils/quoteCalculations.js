...
export function updateMaterialTotals(item = {}, defaultMarkup = 0) {
...
export function updateServiceTotals(item = {}) {
  return {
    ...item,
...
export function calculateQuoteTotals(materials = [], services = [], commercial = {}) {
